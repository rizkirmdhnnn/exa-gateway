  ...
  function ExaGatewayPage() {
    ...
    return React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14, fontFamily: "system-ui" } },
      ...
      tab === "Overview" && React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { style: card }, React.createElement("h2", null, "Configuration"), React.createElement("p", null, "Provider: exa-gateway · API: https://api.exa.ai · Storage: local SQLite"), React.createElement("p", null, "Retry statuses: 402, 429, 500, 502, 503"), )),
